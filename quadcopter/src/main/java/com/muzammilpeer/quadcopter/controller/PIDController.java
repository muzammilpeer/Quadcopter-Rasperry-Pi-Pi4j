...
//        controller.disarmESC(MotorEnum.MOTOR_1);
        controller.arm(controller.thirdMotor, true);

        for (int i = 0; i < 100; i++) {
            controller.changeMotorSpeed(controller.thirdMotor, i);
//            controller.changeMotorsSpeed(i);
//            Thread.sleep(operatingFrequency);
//            controller.changeMotorSpeed(MotorEnum.MOTOR_1, 50);
//            Thread.sleep(operatingFrequency);
//            controller.changeMotorSpeed(MotorEnum.MOTOR_2, 10);
//            Thread.sleep(operatingFrequency);
//            controller.changeMotorSpeed(MotorEnum.MOTOR_3, 75);
//            Thread.sleep(operatingFrequency);
//            controller.changeMotorSpeed(MotorEnum.MOTOR_4, 30);

//            controller.increaseMotorSpeed(controller.firstMotor);
////            controller.increaseMotorSpeed(MotorEnum.MOTOR_1);
//            controller.increaseMotorSpeed(MotorEnum.MOTOR_1);
//            controller.increaseMotorSpeed(MotorEnum.MOTOR_1);
